...
- 2026-09-06 · Codex · Edición de Movimientos entre almacenes: el gateway expone metadatos de ítems y admite nuevos detalles además de actualizar cantidades; el payload se normaliza al formato `actualizarMovimiento` de Restaurant. · No ejecutar Guardar sobre movimientos operativos durante la validación.
