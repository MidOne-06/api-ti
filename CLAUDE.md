...
- 2026-09-06 · Codex · Alta de movimientos: nuevos endpoints de previsualización y guardado replican validar stock → emular → agregar; los catálogos de locales, almacenes e ítems se consultan en Restaurant en cada interacción. · La persistencia sólo ocurre con el POST confirmado por el usuario; no usarla como prueba automática.
