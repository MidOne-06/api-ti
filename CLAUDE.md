...
- 2026-09-07 · Codex · Canje de guías: se corrigió la referencia `movement` al formar los cuerpos de emulación y registro; el alias no definido detenía el flujo antes de llegar a Restaurant. · El canje conserva el control explícito `confirmar: true`.
- 2026-09-07 · Codex · Canje masivo de guías: el gateway agrupa en vivo por local/almacén de origen/local de destino, revalida toda la selección antes de escribir y registra un movimiento independiente por grupo. · Un grupo rechazado se reporta sin ocultar los resultados de los demás; máximo 20 guías por operación.
